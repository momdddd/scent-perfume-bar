    ...
    <div class="product-modal">
      ...
      <div class="modal__footer">
        ...
        <div class="modal__actions">
          <button class="btn btn--gold" onclick="openVolumeSelector(${p.id});document.getElementById('productModal').remove();">
            В корзину
          </button>
          <button class="btn btn--outline" onclick="handleOrder(${p.id})">
